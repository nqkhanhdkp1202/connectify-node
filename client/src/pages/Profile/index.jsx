            ...
            <Box sx={{ position: "relative", width: "56px", height: "fit-content" }}>
              {
                profile?.listFriends?.slice(0, 3).map((e, i) => (
                  <Box component={"img"} src={e.avatar} sx={{ width: "22px", height: "22px", borderRadius: "50%", border: "2px solid white", position: "absolute", left: `${i * 14}px`, top: "50%", transform: "translateY(-50%)", objectFit: "cover" }} />
                ))
              }
            </Box>
