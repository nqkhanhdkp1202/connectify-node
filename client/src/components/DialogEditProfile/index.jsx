        ...
        <React.Fragment>
            ...
            >
                <Box sx={{ width: "520px", height: "fit-content", display: "flex", flexDirection: "column", backgroundColor: "white", alignItems: "center", padding: "24px" }}>
                    <Box component={"img"} src={preview ? preview : DefaultUser} sx={{ width: "86px", height: "86px", borderRadius: "50%", outline: "1px solid rgba(0,0,0,0.1)", objectFit:"cover" }}></Box>
                    ...
                    <Box sx={{ width: "100%", marginTop: "24px" }}>
                        <ButtonRoot onClick={handleUpload} style={{ width: "100%", padding: "16px", fontSize: "15px" }} text="Cập nhật" />
                    </Box>
                </Box>
            </Dialog>
        </React.Fragment>
